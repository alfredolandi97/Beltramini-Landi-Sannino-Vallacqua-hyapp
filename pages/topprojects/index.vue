<template>
    ...
    <div id="card-containerPC">
        <ProjectCard v-for = "topproject of topprojects" :title = "topproject.title" :area_id="topproject.area_id" :info="topproject.info" :link="'/topprojects/'+topproject.id" :logo="topproject.logo"/>
    </div>
